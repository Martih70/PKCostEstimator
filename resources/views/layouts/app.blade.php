...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased" style="background: linear-gradient(135deg, #f7fcff 0%, #f0f7ff 100%); color: #1b1b18;">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <div class="flex-1 space-y-1 px-4 py-6">
                            ...
                            <a href="{{ route('dashboard') }}" class="block rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-900 transition" style="{{ request()->routeIs('dashboard') ? 'background: #f5f5f5; border-left: 3px solid #505b93; color: #1b1b18;' : 'border-left: 3px solid transparent;' }}">
                                <div class="flex items-center gap-3">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #6366f1;">
                            ...
                            <!-- Estimator Section (cost_manager, admin) -->
                            @if(auth()->user()->role === 'cost_manager' || auth()->user()->role === 'admin')
                                <div class="pt-4">
                                    <p class="px-4 text-xs font-black uppercase tracking-wider text-gray-700">Estimator</p>
                                    <div class="mt-3 space-y-1">
                                        <a href="{{ route('estimator.index') }}" class="block rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-900 transition" style="{{ request()->routeIs('estimator.*') ? 'background: #f5f5f5; border-left: 3px solid #505b93; color: #1b1b18;' : 'border-left: 3px solid transparent;' }}">
                                            <div class="flex items-center gap-3">
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #0ea5e9;">
                                ...
                                <!-- Projects Section -->
                                <div class="pt-4">
                                    <p class="px-4 text-xs font-black uppercase tracking-wider text-gray-700">Projects</p>
                                    <div class="mt-3 space-y-1">
                                        <a href="{{ route('admin.projects.create') }}" class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition" style="{{ request()->routeIs('admin.projects.create') ? 'color: #505b93;' : '' }}">
                                            <div class="flex items-center gap-2">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #a855f7;">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                                </svg>
                                                <span>Add Project</span>
                                            </div>
                                        </a>
                                        <a href="{{ route('admin.projects.index') }}" class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition ml-6" style="{{ request()->routeIs('project.report') ? 'color: #505b93;' : '' }}">
                                            <div class="flex items-center gap-2">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #a855f7;">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                                <span>Project Reports (Forecast)</span>
                                            </div>
                                        </a>
                                        <a href="{{ route('project.reports-historical') }}" class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition ml-6" style="{{ request()->routeIs('project.reports-historical', 'project.report-historical') ? 'color: #505b93;' : '' }}">
                                            <div class="flex items-center gap-2">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #a855f7;">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                                <span>Project Reports (Historical)</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            @if(auth()->user()->role === 'reviewer' || auth()->user()->role === 'admin')
                                <a href="{{ route('analytics.index') }}" class="block rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-900 transition" style="{{ request()->routeIs('analytics.*') ? 'background: #f5f5f5; border-left: 3px solid #505b93; color: #1b1b18;' : 'border-left: 3px solid transparent;' }}">
                                    <div class="flex items-center gap-3">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #ec4899;">
                            ...
                            @if(auth()->user()->role === 'admin')
                                <div class="pt-4">
                                    <p class="px-4 text-xs font-black uppercase tracking-wider text-gray-700">Administration</p>
                                    <div class="mt-3 space-y-1">
                                        <!-- Projects (Historical) -->
                                        <a href="{{ route('admin.projects.historical') }}" class="block rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:text-gray-900 transition" style="{{ request()->routeIs('admin.projects.historical') ? 'background: #f5f5f5; border-left: 3px solid #505b93; color: #1b1b18;' : 'border-left: 3px solid transparent;' }}">
                                            <div class="flex items-center gap-3">
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #a855f7;">
