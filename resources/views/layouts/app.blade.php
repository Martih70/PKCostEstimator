                ...
                <nav class="sidebar sidebar-nav" :class="{ 'is-open': sidebarOpen }">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="flex-1 px-3 py-5 space-y-0.5">
                            ...
                            <a href="{{ route('how-it-works') }}" class="nav-link flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium {{ request()->routeIs('how-it-works') ? 'nav-active text-gray-900' : 'text-gray-600 border-l-[3px] border-transparent' }}">
                                <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #6366f1;">
                            ...
                            @if(auth()->user()->role === 'admin')
                                <div class="pt-5">
                                    ...
                                    <a href="{{ route('admin.escalation.index') }}" class="nav-link flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium {{ request()->routeIs('admin.escalation.*') ? 'nav-active text-gray-900' : 'text-gray-600 border-l-[3px] border-transparent' }}">
